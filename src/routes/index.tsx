...
import serviceEvents from "@/assets/service-events.png";
    ...
    services: {
      ...
      list: [
        ...
        },
        {
          ...
          body: "End-to-end consulting and event management for cycling clubs, teams and brands. From route planning and timing to logistics for stage races and rider clinics.",
          bullets: [
            "Race direction & logistics",
  ...
  he: {
    ...
    services: {
      ...
      list: [
        ...
        {
          tag: "02 / אירועים",
          title: "אירועים מקצועיים",
          body: "ייעוץ וניהול מקצה לקצה למועדוני רכיבה, קבוצות ומותגים. מתכנון מסלולים ותזמון ועד לוגיסטיקה למרוצי שלבים וסדנאות לרוכבים.",
          bullets: [
            "ניהול מרוצים ולוגיסטיקה",
            "תמיכה ואימון קבוצות",
            "הפעלת מותגים ונותני חסות",
          ],
        },
      ],
    },
...
function Services() {
  const { t } = useLang();
  const imgs = [serviceFitting, serviceEvents];
  const ids = ["fitting", "events"];
...
function AddressMenu() {
  ...
  return (
    <div ref={ref} dir="ltr" className="relative flex items-start gap-4">
      ...
      <div className="relative flex-1">
        ...
        >
          <span dir="rtl" className="text-start">{t.contact.address}</span>
          <svg
            viewBox="0 0 24 24"
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-16">
        ...
        >
          <div className="grid md:grid-cols-2 gap-px bg-border">
            <input
              dir={dir}
              className="bg-background px-5 py-4 outline-none focus:ring-2 focus:ring-primary text-sm text-start"
          ...
          <input
            className="w-full bg-background px-5 py-4 outline-none focus:ring-2 focus:ring-primary text-sm"
          ...
          />
          <select
            className="w-full bg-background px-5 py-4 outline-none focus:ring-2 focus:ring-primary text-sm border-t border-border"
            value={form.interest}
          ...
          <textarea
            className="w-full bg-background px-5 py-4 outline-none focus:ring-2 focus:ring-primary text-sm border-t border-border min-h-[140px] resize-none"
    ...
    <footer className="border-t border-border py-12">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-6 text-xs uppercase tracking-widest text-muted-foreground">
          ...
          <a href="#events" className="hover:text-primary">{t.footer.links.events}</a>
